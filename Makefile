...
.PHONY: api example test lint typecheck check
...
test:
	$(API_PYTEST) -q services/dma-api/tests packages/dma-sdk-python/tests

lint:
	$(API_RUFF) check services/dma-api/src services/dma-api/tests packages/dma-sdk-python/src packages/dma-sdk-python/tests
